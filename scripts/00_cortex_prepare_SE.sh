...
echo "dummy_reads1" >se_filelist
echo -e  ${REF_NAME}"\tse_filelist\t.\t." >${REF_NAME}_index
...
$PATH_CORTEX/cortex_var_63_c1 --kmer_size 61 --mem_height 21 --mem_width 100 --se_list file_listing_fasta --max_read_len 10000 --dump_binary ref/ref.k61.ctx --sample_id REF
