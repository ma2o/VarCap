...
# SLURM
#SBATCH --job-name=wVCCpi24
#SBATCH --cpus-per-task=2
#SBATCH --mem=8000
#SBATCH --output=pindel24-%A_%a.out
#SBATCH --error=pindel24-%A_%a.err
...
# sam input: ./sam2pindel input.sam Output4Pindel.txt 300 tumour 0
# $PATH_SAM2PINDEL/sam2pindel 
# bam input: ./samtools view input.bam | ./sam2pindel - Output4Pindel.txt 300 tumour 0
$PATH_SAMTOOLS/samtools view $BAM | $PATH_SAM2PINDEL/sam2pindel - $OUTPUT/$BAM_BASE.pindel.txt $INSERT_SIZE E25_varcap 0
