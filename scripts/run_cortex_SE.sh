...
if [[ ! -e $PATH_CORTEX_DATA/ref/ref.k31.ctx ]]; then
  ...
  bash $PATH_SCRIPTS/00_cortex_prepare_SE.sh $PATH_CORTEX_DATA $REF $PATH_VCFTOOLS $PATH_STAMPY $PATH_CORTEX_DIR $PATH_CORTEX $PATH_RUN_CALLS
fi
...
--genome_size 2900000 --max_read_len 10000 --qthresh 5 --mem_height 21 --mem_width 100 --vcftools_dir $PATH_VCFTOOLS \
