...
# SLURM
#SBATCH --job-name=VCtrimmo
#SBATCH --cpus-per-task=2
#SBATCH --mem=16000
#SBATCH --nice=1000
#SBATCH --license=scratch-highio
#SBATCH --output=filter/trimmomatic-%A_%a.out
#SBATCH --error=filter/trimmomatic-%A_%a.err
